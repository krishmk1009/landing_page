...
const Features = () => {
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          ...
          <h3 class="mb-4 text-2xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-5xl"> Features That Power Your <span class="text-transparent bg-clip-text bg-gradient-to-r to-sky-500 from-blue-500">Financial Market Analysis</span> </h3>

          <p class="text-gray-500 sm:text-xl dark:text-gray-400">Empower your financial market analysis with these innovative features. Discover the power of intuitive data visualization, customizable reports, real-time market data, comprehensive analysis, and collaborative insights sharing.</p>
      </div>
      <div class="space-y-8 md:grid md:grid-cols-2  lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg'>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Graphical Charts</h3>
              <p class="text-gray-500 dark:text-gray-400">Transform complex financial market data into easy-to-understand visualizations.</p>
          </div  >
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg'>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Community Access</h3>
              <p class="text-gray-500 dark:text-gray-400">Join a community of like-minded individuals and gain insights from a collective of experts.</p>
          </div>
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg'>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">WhatsApp Alerts</h3>
              <p class="text-gray-500 dark:text-gray-400">Stay informed with real-time notifications delivered directly to your phone via WhatsApp.</p>
          </div>
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg'>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Fast Data Change</h3>
              <p class="text-gray-500 dark:text-gray-400">Quickly respond to market shifts with lightning-fast data updates.</p>
          </div>
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg'>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Live Updates</h3>
              <p class="text-gray-500 dark:text-gray-400">Stay on top of market trends with real-time data updates.</p>
          </div>
          <div className='border border-gray-200 pt-8 pb-8 pr-5 pl-5 rounded-lg hover:bg-gray-100'>
              <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-white">Chat Messenger</h3>
              <p class="text-gray-500 dark:text-gray-400">Collaborate with your team and receive support through our built-in chat messenger.</p>
          </div>
      </div>
  </div>
</section>
